...
test('Test library functions', (t) => {
	...
	//Fix test to UTC+0
	t.equals(xl.getExcelTS(new Date('2015-01-01T00:00:00.0000Z')), 42004, 'Correctly translated date in standard time to excel timestamp');
	t.equals(xl.getExcelTS(new Date('2015-06-01T00:00:00.0000Z')), 42155, 'Correctly translated date in daylight time to excel timestamp');
