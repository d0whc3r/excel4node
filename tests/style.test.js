...
test('Set Style Properties', (t) => {
	...
	t.ok(styleObj.protection.hidden === true, 'protection.hidden correctly set');
	...
	t.ok(protectionXMLString === '<?xml version="1.0"?><test><protection hidden="true" locked="true"/></test>', 'Protection xml created successfully');
