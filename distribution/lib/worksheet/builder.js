...
var _addSheetViews = function _addSheetViews(promiseObj) {
	...
	return new Promise(function (resolve, reject) {
		...
		var sv = ele.ele('sheetView').att('tabSelected', o.tabSelected).att('workbookViewId', o.workbookViewId).att('rightToLeft', o.rightToLeft).att('zoomScale', o.zoomScale).att('zoomScaleNormal', o.zoomScaleNormal).att('zoomScalePageLayoutView', o.zoomScalePageLayoutView).att('showGridLines', o.showGridLines);
